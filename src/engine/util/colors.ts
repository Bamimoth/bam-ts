 ...
 */
 export class Color {
    ...
    constructor(public data: Array<f32>) {
        this.data = data;
    }
    ...
    static fromList(list: Array<f32>) {
        if (list.length != 3) {
            return undefined;
        }
    ...
    equals(rhs: Color) {
        return Color.equals(this, rhs);
    }

    static equals(lhs: Color, rhs: Color) {
        let a = lhs.data;
        let b = rhs.data;
